...
const AddIdAccount: React.FC<UploadedFile> = ({
    ...
    const handleRestrictedAction = () => {
        if (restrictModification) {
            ...
            //     'Vous ne pouvez pas modifier vos documents d\'identification. Veuillez contacter le support.',
            //     [
            //         {
            //             text: 'Contacter le Support',
            //             onPress: () => Linking.openURL('mailto:Unricheunpauvre@gmail.com?subject=Permission pour modifier documents d\'identification')
            //         },
